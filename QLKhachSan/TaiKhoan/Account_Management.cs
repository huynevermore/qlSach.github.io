...
namespace QLKhachSan.TaiKhoan
{
    ...
    public partial class Account_Management : Form
    {
        ...
        // hàm đặt tên colums, độ rộng của datagridview
        ...
        // binding data từ datagridview -> textbox 
        ...
        // binding dữ liệu từ datagridview sang textbox
        ...
        // hàm trả về quyền sử dung admin,  người dùng.
        string check_quyen(string quyen)
        {
            string quyenq = "";
            if (quyen.ToString() == "Admin") quyenq = "1";
            if (quyen.ToString() == "Nguoi Dung" || quyen.ToString() == "") quyenq = "2";
            return quyenq;
        }
        ...
        {
            string sql = "Delete from DangNhap where Taikhoan = '" + txt_tk.Text + "'";
            chuoiketnoi.Xoa(sql);
            chuoiketnoi.Chuoiketnoi(chuoi, data_Account);
            Namecolumn();
            Clear();
        ...
        private void data_Account_Click(object sender, EventArgs e)
        {
            index = data_Account.CurrentRow.Index;
            PopulateData(index);
        }

        private void Account_Management_Load_1(object sender, EventArgs e)
        {
